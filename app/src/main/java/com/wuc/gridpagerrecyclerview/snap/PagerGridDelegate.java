 ...
 * @author : wuchao5
 * @date : 2020/6/4 19:14
 * @desciption : 注意只处理linear和grid布局，实现左右滑动
 ...
 */
public class PagerGridDelegate {
    private OrientationHelper verticalHelper;
    private OrientationHelper horizontalHelper;
    private int gravity;
    private boolean isRtlHorizontal;
    private boolean snapLastItem;
    private PagerGridSnapHelper.SnapListener listener;
    ...
    public PagerGridDelegate(int gravity, boolean enableSnapLast, PagerGridSnapHelper.SnapListener listener) {
